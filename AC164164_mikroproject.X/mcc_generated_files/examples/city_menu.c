...
void Draw_Return_Button(void) {
    ...
    TFT_DrawRect(RETURN_X, RETURN_Y, MENU_WIDTH, MENU_HEIGHT - 1, TFT_RED);
    TFT_Print(RETURN_X + 30, RETURN_Y + 10, "Return", TFT_WHITE, TFT_BLACK, 2);
}
